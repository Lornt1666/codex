"""Blender script to convert depth map to mesh.

Usage: blender -b -P depth_to_mesh.py -- <depth.png> <out.stl|out.obj>
"""
import sys
...
def main():
    ...
    if not BLENDER_AVAILABLE:
        print("Error: bpy (Blender Python API) not available")
        sys.exit(1)
